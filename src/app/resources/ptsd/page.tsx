...
export default function ResourcePage() {
    ...
    const resourceDetails = resourcePages['ptsd'];
    ...
    return (
        width > 640 ? (
            <div className="w-full flex flex-col justify-center items-center mt-10 mb-10">
                ...
                <div className="w-3/4 rounded-md bg-blue flex flex-col items-center justify-center p-6 mb-4">
                    ...
                    <div className="h-[60%] w-full flex justify-evenly items-center mb-4">
                        <div className="w-[10%]" />
                        <iframe className="mr-4" src="https://www.youtube.com/embed/2KXtlIX_yUs" />
                        <iframe src="https://www.youtube.com/embed/uoJBvXAUvA8" />
                        <iframe className="ml-4" src="https://www.youtube.com/embed/0x9_CRqshro" />
                        <div className="w-[10%]" />
                    </div>
                </div>
            ...
            <div className="w-full flex flex-col justify-center items-center mt-8 mb-10">
                <div className="w-3/4 bg-blue text-center font-poppins text-white text-2xl flex justify-center items-center p-2 rounded-md font-bold mb-4">
                    <a href="/resources">{resourceDetails.title} Resources</a>
                </div>
                <div className="w-3/4 rounded-md bg-darkblue flex flex-col items-center justify-center p-6 mb-4">
                    <div className="w-full h-[20%] flex items-center justify-center mb-4">
                ...
                <div className="w-3/4 rounded-md bg-blue flex flex-col items-center justify-center p-6 mb-4">
                    ...
                    <div className="h-[60%] w-full flex flex-col justify-evenly items-center mb-4">
                        <iframe className="mb-4 w-[80%]" src="https://www.youtube.com/embed/2KXtlIX_yUs" />
                        <iframe className="mb-4 w-[80%]" src="https://www.youtube.com/embed/uoJBvXAUvA8" />
                        <iframe className="w-[80%]" src="https://www.youtube.com/embed/0x9_CRqshro" />
                    </div>
                </div>
